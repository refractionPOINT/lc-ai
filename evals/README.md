...
Scenarios are harness-independent in meaning and grading, but the current implementation still has explicit scenario dispatch. Adding YAML alone does not register an eval. Workspace remains unsupported until its isolation and telemetry contract is verified.
