...
flowchart TD
    ...
    doc -->|New compromised endpoint?| newticket["Create new ticket<br/>(picked up by Bulk Triage in next hourly run)"]
...
New tickets created by the Threat Hunter will be reviewed in the next Bulk Triage cycle, ensuring findings are properly assessed and tracked.
