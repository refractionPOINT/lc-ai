...
3. **Collect Data**: Use `limacharlie org list --output yaml` to list organizations, then spawn `org-reporter` agents in parallel to collect data from each organization
